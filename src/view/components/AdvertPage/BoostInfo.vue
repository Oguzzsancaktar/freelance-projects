            ...
            <div class="item">
              ...
              <div class="select">
                <SelectBox
                  ...
                  :placeholder="BoostInfoData.Placeholder"
                />
              </div>
              <div class="padding">
                <div class="checkbox">
        ...
        <section>
          <div class="col">
            ...
            <div class="item">
              ...
              <div class="row col">
                <span class="card-nums">
                  {{ BoostInfoData.ExpirationDate }}
                </span>
            ...
            <div class="item">
              <Button
                ...
                :text="BoostInfoData.FinishPayment"
                fontSize="19px"
                family="var(--font-semibold)"
                radius="10px"
                padding="25px 0"
...
export default {
  components: { SelectBox, Checkbox, InputBox, Button },
  name: "BoostInfo",
  props: {
