...
const MessageIcon: React.FC<IIconProps> = ({ color, size }) => {
  return (
    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <filter id="filter0_d_299_669" x="-2.00488" y="1.91699" width="50.0049" height="44.2588" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
